...
| 配置参数                          | 预览效果                            | 描述               |
| --------------------------------- | ----------------------------------- | ------------------ |
| `limit_x=15, limit_y=15`          | ![小范围](demos/demo_small.gif)     | 紧凑集中的图案     |
| `limit_x=11111111195, limit_y=15` | ![宽范围](demos/demo_wide.gif)      | 水平拉伸的窄图案   |
| `limit_x=11111111195, limit_y=95` | ![当前配置](demos/demo_current.gif) | 当前默认配置       |
| `limit_x=500, limit_y=500`        | ![大范围](demos/demo_large.gif)     | 中等范围，平衡图案 |
